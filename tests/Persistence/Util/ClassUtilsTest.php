...
namespace Doctrine\Tests\Persistence\Util

{

    use Doctrine\Persistence\Util\ClassUtils;
    ...
    class ClassUtilsTest extends DoctrineTestCase
    {
        ...
        public static function dataGetClass()
        {
            return [
                ...
                [ 'MyProject\Proxies\__CG__\Doctrine\Tests\Persistence\Util\ChildObject', ChildObject::class],
            ];
        }
        ...
        {
            $parentClass = ClassUtils::getParentClass('MyProject\Proxies\__CG__\OtherProject\Proxies\__CG__\Doctrine\Tests\Persistence\Util\ChildObject');
...
namespace MyProject\Proxies\__CG__\Doctrine\Tests\Persistence\Util

{
    class ChildObject extends \Doctrine\Tests\Persistence\Util\ChildObject
    {
    }
}
...
namespace MyProject\Proxies\__CG__\OtherProject\Proxies\__CG__\Doctrine\Tests\Persistence\Util

{
    class ChildObject extends \MyProject\Proxies\__CG__\Doctrine\Tests\Persistence\Util\ChildObject
    {
    }
}
